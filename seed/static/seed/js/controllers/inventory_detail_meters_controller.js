angular.module('BE.seed.controller.inventory_detail_meters', []).controller('inventory_detail_meters_controller', [
  ...
  function (
    ...
    $scope.scenarios = _.uniqBy(
      _.map(meters, function (meter) {
        return {
    ...
    var filterByMeterSelections = function (readings, columnDefs, meterSelections) {
      ...
      var selectedMeterLabels = meterSelections
    ...
    var filterByScenarioSelections = function (readings, columnDefs, meters, scenarioSelections) {
      var selectedScenarioIds = scenarioSelections
        .filter(function (selection) {
          return selection.selected;
        })
        .map(function (selection) {
      ...
      var selectedMeterLabels = meters
