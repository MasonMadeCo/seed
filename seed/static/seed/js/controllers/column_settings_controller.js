...
angular.module('BE.seed.controller.column_settings', []).controller('column_settings_controller', [
  ...
  function (
    ...
    $scope.comstock_types = [
      ...
      {
        id: 'hvac_system_type',
        label: $translate.instant('comstock.hvac_system_type')
      },
      {
        id: 'rentable_area',
        label: $translate.instant('comstock.rentable_area')
      },
      {
        id: 'number_of_stories',
        label: $translate.instant('comstock.number_of_stories')
      },
      { id: 'year_built', label: $translate.instant('comstock.year_built') },
      {
        id: 'weekend_start_time',
        label: $translate.instant('comstock.weekend_start_time')
      },
      {
        id: 'weekend_duration',
        label: $translate.instant('comstock.weekend_duration')
      },
      {
        id: 'weekday_start_time',
        label: $translate.instant('comstock.weekday_start_time')
      },
      {
        id: 'weekday_duration',
        label: $translate.instant('comstock.weekday_duration')
      },
      {
        id: 'building_shape',
        label: $translate.instant('comstock.building_shape')
      },
      { id: 'built_code', label: $translate.instant('comstock.built_code') },
      { id: 'rotation', label: $translate.instant('comstock.rotation') },
      {
        id: 'aspect_ratio',
        label: $translate.instant('comstock.aspect_ratio')
      },
      {
        id: 'building_type',
        label: $translate.instant('comstock.building_type')
      },
      { id: 'state', label: $translate.instant('comstock.state') },
      { id: 'county', label: $translate.instant('comstock.county') },
      {
        id: 'climate_zone',
        label: $translate.instant('comstock.climate_zone')
      }
    ];
