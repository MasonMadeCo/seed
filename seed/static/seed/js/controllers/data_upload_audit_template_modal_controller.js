 ...
 */
angular
  .module('BE.seed.controller.data_upload_audit_template_modal', [])
  .controller('data_upload_audit_template_modal_controller', [
    ...
    function (
      ...
      $scope.submit_request = function () {
        ...
        return audit_template_service
          .get_building_xml($scope.organization.id, $scope.fields.audit_template_building_id)
          .then(result => {
            ...
            if (typeof result == 'object' && !result.success) {
              ...
              return audit_template_service
                .update_building_with_xml($scope.organization.id, $scope.cycle_id, $scope.view_id, result)
                .then(result => {
                  $scope.close();
