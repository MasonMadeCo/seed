angular.module('BE.seed.controller.sensor_readings_upload_modal', []).controller('sensor_readings_upload_modal_controller', [
  '$scope',
  '$state',
  '$uibModalInstance',
  'uiGridConstants',
  ...
  'datasets',
  'data_logger_id',
  function ($scope, $state, $uibModalInstance, uiGridConstants, filler_cycle, dataset_service, organization_id, uploader_service, view_id, datasets, data_logger_id) {
    $scope.step = {
      number: 1
    };
