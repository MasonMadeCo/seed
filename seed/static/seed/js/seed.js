      ...
      .state({
        ...
        resolve: {
          ...
          organizations_payload: [
            ...
            function (auth_payload, organization_service) {
          ...
          users_payload: [
            'auth_payload',
            'user_service',
            function (auth_payload, user_service) {
              // Require auth_payload to successfully complete before attempting
      ...
      .state({
        ...
        resolve: {
          analyses_payload: [
            'analyses_service',
            'user_service',
            function (analyses_service, user_service) {
          ...
          users_payload: [
            ...
            function (organization_service, user_service) {
              return organization_service.get_organization_users({
      ...
      .state({
        ...
        resolve: {
          ...
          cycles_payload: [
            'cycle_service',
            '$stateParams',
            function (cycle_service, $stateParams) {
        ...
        resolve: {
          ...
          organization_payload: [
            ...
            function (organization_service, $stateParams, $q) {
              var organization_id = $stateParams.organization_id;
              return organization_service.get_organization(organization_id).then(function (data) {
      ...
      .state({
        ...
        resolve: {
          ...
          templates_payload: [
            'postoffice_service',
            '$stateParams',
            function (postoffice_service, $stateParams) {
      ...
      .state({
        ...
        resolve: {
          ...
          labels: [
            '$stateParams',
            'label_service',
            function ($stateParams, label_service) {
      ...
      .state({
        ...
        resolve: {
          ...
          labels_payload: [
            ...
            'inventory_payload',
            'label_service',
            function ($stateParams, inventory_payload, label_service) {
