...
angular.module('ui.grid').config([
  ...
  function ($provide) {
    ...
    $provide.decorator('rowSearcher', [
      '$delegate',
      'gridUtil',
      function ($delegate, gridUtil) {
        $delegate.search = function (grid, rows, columns) {
          ...
          for (var i = 0; i < colsLength; i++) {
            ...
            if (typeof col.filters !== 'undefined' && hasTerm(col.filters)) {
              filterData.push({
                col: col,
                filters: $delegate.setupFilters(col.filters)
              });
            }
          }
    ...
    $provide.decorator('uiGridHeaderCellDirective', [
      '$delegate',
      '$compile',
      '$timeout',
      '$window',
            ...
            post: function ($scope, $elm, $attrs, controllers) {
              ...
              $scope.isSortPriorityVisible = function () {
                ...
                return (
                  $scope.col &&
                  $scope.col.sort &&
                  angular.isNumber($scope.col.sort.priority) &&
              ...
              $scope.getSortDirectionAriaLabel = function () {
                ...
                var label =
                  col.sort && col.sort.direction === uiGridConstants.ASC
                    ? $scope.i18n.sort.ascending
                    : col.sort && col.sort.direction === uiGridConstants.DESC
                    ? $scope.i18n.sort.descending
                    : $scope.i18n.sort.none;
                ...
                if (updateFilters) {
                  ...
                  if ($scope.col.filterable) {
                    $scope.col.filters.forEach(function (filter, i) {
                      filterDeregisters.push(
                        $scope.$watch('col.filters[' + i + '].term', function (n, o) {
                          if (n !== o) {
